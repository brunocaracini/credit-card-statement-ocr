...
class OcrEngine:
    ...
    STATEMENT_DATES = {
        ...
        "NEXT_DUE_DATE": ["PROXIMOVENCIMIENTO", "PROXIMOVTO", "PROXIMOVTO.","PROXIMOVTO.:", "PROXIMOVENCIMIENTO:","PROXIMOVTO:"],
        "CURRENT_CLOSURE": ["CIERREACTUAL","CIERREACTUAL:"],
        "NEXT_CLOSURE": ["PROXIMOCIERRE", "PROXIMOCIERRE:"]
    }
